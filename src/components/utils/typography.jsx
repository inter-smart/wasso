...
const headingVariants = cva("leading-tight font-light", {
  variants: {
    size: {
      h1: "text-[30px] sm:text-[40px] xl:text-[54px] 2xl:text-[65px] 3xl:text-[80px]",
      h2: "text-[26px] sm:text-[36px] xl:text-[48px] 2xl:text-[58px] 3xl:text-[70px]",
      h3: "text-[22px] sm:text-[32px] xl:text-[40px] 2xl:text-[48px] 3xl:text-[60px]",
      h4: "text-[15px] sm:text-[18px] xl:text-[20px] 2xl:text-[24px] 3xl:text-[30px]",
      h5: "text-[15px] sm:text-[16px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[25px]",
      h6: "text-[14px] sm:text-[13px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px]",
      h7: "text-[13px] 2xl:text-[14px] 3xl:text-[18px]",
      h8: "text-[20px] sm:text-[24px] xl:text-[30px] 2xl:text-[36px] 3xl:text-[45px]",
    },
  },
  defaultVariants: {
    size: "h1",
