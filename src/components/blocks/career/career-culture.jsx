...
export default function CareerCulture({ data, locale }) {
  return (
    <section className="w-full pt-[20px] sm:pt-[25px] xl:pt-[50px] 2xl:pt-[70px] 3xl:pt-[85px] overflow-hidden">
      <div className="container">
        <div className="flex flex-wrap md:-mx-[25px] xl:-mx-[50px] 2xl:-mx-[70px] 3xl:-mx-[85px] md:[&>*]:px-[25px] xl:[&>*]:px-[50px] 2xl:[&>*]:px-[70px] 3xl:[&>*]:px-[85px]">
